...
{
  "schemaVersion": "1.5",
  "scannerVersionTarget": "1.5"
}
```

Pester tests assert this schema version when loading the manifest. Fixture entries include expected text findings, JSON-summary expectations, SBOM presence/component-count expectations, binary-inspection expectations, and optional `expectedUnsupportedFiles` arrays for v1.5 scanner expectations.
